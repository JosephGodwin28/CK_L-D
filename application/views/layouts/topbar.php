                    ...
                    <li>
                       <a class="dropdown-item" href="#">
                         <div class="d-flex flex-row align-items-center gap-2">
                            ...
                            <div class="">
                              <h6 class="mb-0 dropdown-user-name"><p><?php echo $this->session->userdata('username'); ?></p></h6>
                     ...
                     <li>
                      ...
                      <li>
                        <a class="dropdown-item" href="authentication-signup-with-header-footer.html">
                           <div class="d-flex align-items-center">
                             <div class=""><ion-icon ></ion-icon></div>
                             <div class="ms-3"><a class="dropdown-item" href="<?php echo base_url();?>logout"><i
                    class="bx bx-power-off"></i><span>Logout</span></div>
                           </div>
                         </a>
                      </li>
                  </ul>
