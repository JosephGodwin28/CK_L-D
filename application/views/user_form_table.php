        ...
        <div class="page-content-wrapper">
         ...
         <div class="page-content">
          ...
          <h6 class="mb-0 text-uppercase">Trainee Listing</h6>
				<hr/>
				<div class="col">
                    <a type="button" href="<?php echo base_url();?>AdminController/create_user_form"  class="btn btn-primary px-5"> + Add Trainee</a>
                </div>
                  <br>
				<div class="card">
                    <br>
                    <form  id="assignSubmit" method="POST" action="javascript:void(0)">
                        ...
                        <div class="row" style="padding: 10px;">
                            <!-- <div class="col-md-2">
                                <h6>Employee name</h6>
                                <select name="emp_code" id="emp_code" class="form-select" required>
                                    <option value="">Select Emp</option>
                                    <option value="emp001">Krish</option>
                                    <option value="emp002">Bala</option>
                                    <option value="emp003">Kumar</option>
                                    <option value="emp004">Abi</option>
                                </select>
                            </div> -->
                            <div class="col-md-2">
                                <h6>Trainer Name</h6>
                                <select class="form-select" name="trainer_name" id="trainer_name" class="form-control single-select" required>
                                <option value=""></option>
                                </select>
                            </div>
                            <div class="col-md-2">
                                <h6>Training Start Date </h6>
                                <input type="date" name="date_emp" id="date_emp" class="form-control" required>
                            </div>
                            <div class="col-md-3">
                                <br>
