...
<!--sidebar-wrapper-->
         ...
         <div class="page-content">
            <div class="row">
              <div class="col-xl-12 mx-auto">
                <h6 class="mb-0 text-uppercase">Report OJT TRACKER</h6>
                <hr/>
                <div class="card">
                  <div class="card-body">
                    <div class="p-4 border rounded">
                      <form class="row g-3 needs-validation" id="formojt" action="javascript:void(0)" method="POST"  autocomplete="off" novalidate--
                      >  
                        ...
                        <div class="row" style="padding: 10px;">
                            <div class="col-md-2">
                                <h6>Batch code</h6>
                              <select class="form-select form-select2 valid_frm" id="batch_code" name="batch_code" aria-controls="child-table" onchange="return list_ojt(),get_ojt_trainee_list(this.value)">
                              ...
                              <div class="col-md-2">
                                  <h6>Day</h6>
                                    <select class="form-select form-select1 valid_frm" name="day" id="day" onchange="return list_ojt()" >
                                      <option selected disabled></option>
                                      <option value="1" id="day1" >Day 1</option>
                                      <option value="2" id="day2" >Day 2</option>
                                      <option value="3" id="day3" >Day 3</option>
                                    </select>
                              </div>
                              <div class="col-md-2">
                                  <h6>Trainee code</h6>
                                  <select class="form-select form-select2 valid_frm" id="trainee_code" name="trainee_code" onchange="return list_ojt()"  >
                                      <option selected disabled></option>
                                      <?php
  ...
  <!--end wrapper-->
    ...
    <script src="<?php echo asset_url();?>plugins/notifications/js/notification-custom-script.js"></script>
     <!-- ojt function js -->
    <script src="<?php echo asset_url();?>pro_js/report_ojt_tracker.js"></script>
