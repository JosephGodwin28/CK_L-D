...
<!--sidebar-wrapper-->
                  ...
                  <div class="card-body">
                    <div class="p-4 border rounded">
                      <form class="row g-3 needs-validation" id="userFormEdit" action="javascript:void(0)" method="POST"  autocomplete="off" novalidate>
                        ...
                        <div class="col-md-4 position-relative" onload="validDate()">
                         ...
                         <div class="col-md-4 position-relative">
                          ...
                          <input type="text" class="form-control" maxlength="10" id="emp_alt_num" name="emp_alt_num" required>
                          <!-- <div class="valid-tooltip">
                            Looks good!
                          </div> -->
                        </div>  
                        ...
                        <div class="col-12">
                          <center>
                            ...
                            <button class="btn btn-danger px-5 rounded-0" onclick="window.location.href='<?php echo base_url();?>AdminController/user_form_table'" type="button">Cancel</button>
                          </center>
                        </div>
                      </form>
                    </div>
  ...
  <!-- validation -->
    ...
    <!-- login function js -->
    <script src="<?php echo asset_url();?>pro_js/edit_user_form.js"></script>
