...
<!--sidebar-wrapper-->
        ...
        include('application/views/layouts/emp/sidebar.php'); ?>
                  ...
                  <div class="card-body">
                    <div class="p-4 border rounded">
                      ...
                      >  
                        ...
                        <?php echo form_open_multipart('index.php/AttendanceController/form_store_attendance_tracker', array('method' => 'post', 'id' => 'formattendance','class' => 'needs-validation', 'autocomplete' => 'off','novalidate'=>'novalidate'));?>
                        <input type="hidden" class="form-control" id="created_by" name="created_by" value=<?php echo $this->session->userdata('username'); ?>>
                        <div class="row" style="padding: 10px;">
                            <div class="col-md-2">
                                <h6>Batch code</h6>
                              <select class="form-select form-select2 valid_frm" id="batch_code" name="batch_code" aria-controls="child-table" onchange="return list_attendance(),get_attendance_trainee_list(this.value)">
                              ...
                              <div class="col-md-2">
                                  <h6>Trainee code</h6>
                                  <select class="form-select form-select2 valid_frm" id="trainee_code" name="trainee_code" onchange="return list_attendance()"  >
                                      <option selected disabled></option>
                                      <?php
                        ...
                        <div class="table-responsive">
                            <div id="tableDiv">
                              <table id="displayTable"  class="table table-striped table-bordered" style="width:100%">
                                  <thead>
                                    <tr role="row">
                                            <th>Sno</th>
                                            <th>Location</th>
  ...
  <!--end wrapper-->
    ...
    <script src="<?php echo asset_url();?>plugins/notifications/js/notification-custom-script.js"></script>
     <!-- attendance function js -->
    <script src="<?php echo asset_url();?>pro_js/report_attendance.js"></script>
    ...
    $( document ).ready( function( $ ) {
        /*$.ajax({
                "url": '<?php echo asset_url();?>arrays_short.txt',
                "success": function(json) {
                  console.log('chesk'+json.columns);
                    var tableHeaders;
