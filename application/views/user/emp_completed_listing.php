      ...
      <!--sidebar-wrapper-->
                                    ...
                                    <table class="table table-bordered" id="adt_tb">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th> Average Score </th>
                                                <th> Punctuality </th>
                                                <th> Completion Assignment </th>
                                                <th> Participation Act </th>
                                                <th> Understanding Content </th>
                                                <th> Communication </th>
                                                <th> Confidence </th>
                                                <th> Askin Questions </th>
                                                <th> Remarks </th>
                                            </tr>
                                        </thead>
        ...
        <div class="page-content-wrapper">
         ...
         <div class="page-content">
          ...
          <h6 class="mb-0 text-uppercase">Trainee Completed Listing</h6>
                <hr/>
                  <br>
                <div class="card">
                    <br>
...
<script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
  ...
  <script type="text/javascript">
    ...
    <!-- data for table -->
    <script src="<?php echo asset_url();?>pro_js/emp_completed_list.js"></script>
