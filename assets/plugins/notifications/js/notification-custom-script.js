  function login_success() {
	...
	function trainee_success() {
	  	Lobibox.notify('success', {
			pauseDelayOnHover: true,
			continueDelayOnInactiveTab: false,
			position: 'top right',
			icon: 'bx bx-check-circle',
			msg: 'Trainee Create Successfully..!'
		});
	}

	function trainee_failed() {
		Lobibox.notify('error', {
			pauseDelayOnHover: true,
			continueDelayOnInactiveTab: false,
			position: 'top right',
	...
	function trainee_failed_update() {
		Lobibox.notify('error', {
			pauseDelayOnHover: true,
			continueDelayOnInactiveTab: false,
			position: 'top right',
	...
	function trainee_assigned_faild() {
		Lobibox.notify('error', {
			pauseDelayOnHover: true,
			continueDelayOnInactiveTab: false,
			position: 'top right',
			icon: 'bx bx-error',
			msg: 'Assigned Failed..! Try Again..!'
		});
	}

	function checkbox_faild() {
		Lobibox.notify('error', {
			pauseDelayOnHover: true,
			continueDelayOnInactiveTab: false,
			position: 'top center',
			icon: 'bx bx-error',
			msg: 'Select the checkbox to proceed further..!'
		});
	}
