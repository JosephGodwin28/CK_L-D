$(document).ready(function() {
    ...
    $('#dt-server-processing').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "https://codedthemes.com/demos/admin-templates/guru-able/default/dt-json-data/scripts/server-processing.php",
        "columns": [
            { "data": "first_name" },
            { "data": "last_name" },
            { "data": "position" },
    ...
    $('#dt-http').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "https://codedthemes.com/demos/admin-templates/guru-able/default/dt-json-data/scripts/server-processing.php",
            data: function(d) {
                d.myKey = "myValue";
    ...
    $('#dt-post').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "https://codedthemes.com/demos/admin-templates/guru-able/default/dt-json-data/scripts/post.php",
            type: "post"
        },
        "columns": [
            { "data": "first_name" },
    ...
    $('#dt-ajax-array').DataTable({
        "ajax": "https://codedthemes.com/demos/admin-templates/guru-able/default/dt-json-data/arrays.txt"
    });
    $('#dt-ajax-object').DataTable({
        "ajax": "https://codedthemes.com/demos/admin-templates/guru-able/default/dt-json-data/objects.txt",
        "columns": [
            { "data": "name" },
            { "data": "position" },
            { "data": "office" },
    ...
    $('#dt-nested-object').DataTable({
        "processing": true,
        "ajax": "https://codedthemes.com/demos/admin-templates/guru-able/default/dt-json-data/objects_deep.txt",
        "columns": [
            { "data": "name" },
            { "data": "hr.position" },
            { "data": "contact.0" },
    ...
    $('#dt-orthogonal').DataTable({
        ajax: "https://codedthemes.com/demos/admin-templates/guru-able/default/dt-json-data/orthogonal.txt",
        columns: [
            { data: "name" },
            { data: "position" },
            { data: "office" },
    ...
    $('#ajax-table').DataTable({
        "ajax": 'https://codedthemes.com/demos/admin-templates/guru-able/default/dt-json-data/ajax-table.json'
    });
    ...
    $('#server-table').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "https://codedthemes.com/demos/admin-templates/guru-able/default/dt-json-data/server-table.php"
    });
    ...
    var ct = $('#child-table').DataTable({
        "ajax": "https://codedthemes.com/demos/admin-templates/guru-able/default/dt-json-data/ajax-child-rows.json",
        "columns": [{
